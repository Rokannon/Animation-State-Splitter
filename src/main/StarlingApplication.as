package main {
	...
	public class StarlingApplication extends Sprite {
		...
		public function launch():void {
			...
			_navigator.addScreen(SCREEN_STATE_EDIT, new ScreenNavigatorItem(StateEditScreen, events, _stateEditProperties));
		...
		[Inline]
		private final function onBrowsingComplete():void {
